...
<body>
    <div class="navbar">
        ...
        <div class="nav-links">
            ...
            <div class="dropdown">
                <a href="#" class="dropbtn"><i class="fas fa-user-circle"></i>Account</a>
                <div class="dropdown-content">
                    <a href="<%= request.getContextPath() %>/common/bookinghistory.jsp"><i class="fas fa-history"></i>Booking History</a>
